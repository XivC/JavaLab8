...
import com.xivs.common.parameters.Parameter;
...
public abstract class NumericalParameter<T extends Number> extends Parameter<T> {
    ...
    boolean validate(T value) {
        ...
        if (this.lowerBound != null && this.compareValues(this.lowerBound, value) > 0) return false;
        if (this.upperBound != null && this.compareValues(this.upperBound, value) < 0) return false;
        return true;
    }
