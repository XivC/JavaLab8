...
public class WorkerCircle extends Ellipse2D{
    ...
    public WorkerCircle (double x, double y, double radius, double targetX, double targetY, double velocity_x, double velocity_y, String key, Color color){
        this.centreX = x;
        this.centreY = y;
